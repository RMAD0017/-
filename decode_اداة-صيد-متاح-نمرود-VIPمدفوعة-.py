...
from pystyle import *
print('—'*25)
print('• المـبـࢪمج ☆𝑆𝐷𝑀☆ نـمࢪود •')
print('—'*25)
SDMK=""" \x1b[38;5;193m \x1b[38;5;191m
   ─
...
print(SDMK) 
print('—'*25)
print('• The programmer Abu Khalaf  •')
print('—'*25)
Proxy = '.'
from pyfiglet import Figlet as F; from random import choice as c; print("\033[92m" + F(c(["block","banner","bubble","catwalk","isometric1","isometric2","letters","doom","fuzzy","slant","big","poison","speed","train"])).renderText("نـمࢪود SDM"))   
print(Proxy)
SDMT = Write.Input("\033[2;36m[𖤤نـمࢪود] ENTER TOKEN : ",Colors.red,interval=0.04)
print(Proxy) 
SDMD = Write.Input("\033[2;36m [𖤤نـمࢪود] ENTER ID : ",Colors.blue,interval=0.04)
print(Proxy) 
code = ''
exec(code)
def SDMgmail(email):	
...
☣⫘⫘⫘⫘⁅𖤤نـمࢪود S D M 𖤤⁆⫘⫘⫘⫘☣
• المـبـࢪمج ☆𝑆𝐷𝑀☆ نـمࢪود •
◆ - المبࢪمج:- @Plya_Team , قناتي :- @Plya_Team""")	
				  	requests.post(f"https://api.telegram.org/bot{SDMT}/sendMessage?chat_id={SDMD}&text="+str(SDMhunt))
		  		except:
		  			SDMhunt = (f"""
• المـبـࢪمج ☆𝑆𝐷𝑀☆ نـمࢪود •
- VIP° نـــمـــࢪود ° .
